...
Git is a distributed version control system designed to track changes in source code during software development. With its powerful branching and merging capabilities, it allows multiple developers to work concurrently, ensuring code integrity and history traceability.

Project Homepage: [Git: Fast, Scalable, Distributed Revision Control System](https://git-scm.com/)
...
| `git-flow feature finish <feature_name> [--squash]` | `git checkout develop`<br>`git merge [--squash] --no-ff feature/<feature_name>`<br>`git branch -d feature/<feature_name>` |
